function [time_pow, norm_pow, parameters, efreq, eamp, ephi, r1, tp, ief, amp_curve, ph_curve, if_curve, filled_signal, ridge_curve, parameters_results] = pipeline_single_channel_v11_no_control(x, t, fs, freq_faslt, channel_id)
