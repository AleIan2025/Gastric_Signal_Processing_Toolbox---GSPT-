function [time_pow, norm_pow, parameters, efreq, eamp, ephi, r1, tp, ief, amp_curve, ph_curve, if_curve, filled_signal, ridge_curve, parameters_results] = pipeline_single_channel_v11(x, t, fs, freq_faslt, channel_id)
...
function [parameters, efreq, eamp, ephi, tp, ief, amp_curve, ph_curve, if_curve, ridge_curve, filled_signal, r1, parameters_results] = ...
    ...
    [efreq, eamp, ephi, ~, amp_curve, ph_curve, if_curve] = wavelet_inst_extr_v4(x, t, [], 'on', fs);
    if is_globally_significant
